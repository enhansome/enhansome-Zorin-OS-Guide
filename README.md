...
[K3s](https://github.com/rancher/k3s) ⭐ 33,862 | 🐛 83 | 🌐 Go | 📅 2026-08-28 is a highly available, certified Kubernetes distribution designed for production workloads in unattended, resource-constrained, remote locations or inside IoT appliances.
...
[Chainer](https://chainer.org/) is a Python-based deep learning framework aiming at flexibility. It provides automatic differentiation APIs based on the define-by-run approach (dynamic computational graphs) as well as object-oriented high-level APIs to build and train neural networks. It also supports CUDA/cuDNN using [CuPy](https://github.com/cupy/cupy) ⭐ 12,299 | 🐛 710 | 🌐 Python | 📅 2026-09-01 for high performance training and inference.
...
[Google's Differential Privacy Library](https://github.com/google/differential-privacy) ⭐ 3,350 | 🐛 62 | 🌐 Go | 📅 2026-08-28
...
[Podman(the POD MANager)](https://github.com/containers/podman) ⭐ 32,752 | 🐛 1,141 | 🌐 Go | 📅 2026-09-01 is a tool for managing [OCI](https://opencontainers.org/) containers and pods.
...
[Style Guide for Flutter](https://github.com/flutter/flutter/wiki/Style-guide-for-Flutter-repo) ⭐ 178,735 | 🐛 13,167 | 🌐 Dart | 📅 2026-09-01
...
[Go-flutter](https://github.com/go-flutter-desktop/go-flutter) ⭐ 5,931 | 🐛 64 | 🌐 Go | 📅 2026-09-01 is a package that brings Flutter to the desktop. project implements the [Flutter's Embedding API](https://github.com/flutter/flutter/wiki/Custom-Flutter-Engine-Embedders) ⭐ 178,735 | 🐛 13,167 | 🌐 Dart | 📅 2026-09-01 using a single code base that runs on Windows, macOS, and Linux. For rendering, [GLFW](https://github.com/go-gl/glfw) ⭐ 1,691 | 🐛 22 | 🌐 C | 📅 2026-08-23 fits the job because it provides the right abstractions over the OpenGL's Buffer/Mouse/Keyboard for each platform.
