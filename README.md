...
[Pop Shell](https://github.com/pop-os/shell) ⭐ 5,270 | 🐛 449 | 🌐 TypeScript | 📅 2026-07-06 is a keyboard-driven layer for GNOME Shell which allows for quick and sensible navigation and management of windows. The core feature of Pop Shell is the addition of advanced tiling window management similar to i3wm.
...
[Proton](https://github.com/ValveSoftware/Proton/) ⭐ 32,569 | 🐛 5,175 | 🌐 C++ | 📅 2026-08-18 is a tool for use with the Steam client which allows games which are exclusive to Windows to run on the Linux operating system. It uses Wine to facilitate this.
...
[Kata Operator](https://github.com/openshift/kata-operator) ⭐ 50 | 🐛 71 | 🌐 Shell | 📅 2026-08-18 is an operator to perform lifecycle management (install/upgrade/uninstall) of [Kata Runtime](https://katacontainers.io/) on Openshift as well as Kubernetes cluster.
...
[The JPL Open Source Rover](https://github.com/nasa-jpl/open-source-rover) ⭐ 9,586 | 🐛 18 | 🌐 Prolog | 📅 2026-08-13 is an open source, build it yourself, scaled down version of the 6 wheel rover design that JPL uses to explore the surface of Mars. The Open Source Rover is designed almost entirely out of consumer off the shelf (COTS) parts. This project is intended to be a teaching and learning experience for those who want to get involved in mechanical engineering, software, electronics, or robotics.
...
[Hubble](https://github.com/cilium/hubble) ⭐ 4,295 | 🐛 46 | 🌐 Makefile | 📅 2026-08-18 is a Network, Service & Security Observability for Kubernetes using eBPF.
...
[Podman(the POD MANager)](https://github.com/containers/podman) ⭐ 32,608 | 🐛 1,135 | 🌐 Go | 📅 2026-08-18 is a tool for managing [OCI](https://opencontainers.org/) containers and pods.
...
[Style Guide for Flutter](https://github.com/flutter/flutter/wiki/Style-guide-for-Flutter-repo) ⭐ 178,440 | 🐛 13,162 | 🌐 Dart | 📅 2026-08-18
...
[Go-flutter](https://github.com/go-flutter-desktop/go-flutter) ⭐ 5,931 | 🐛 65 | 🌐 Go | 📅 2026-08-17 is a package that brings Flutter to the desktop. project implements the [Flutter's Embedding API](https://github.com/flutter/flutter/wiki/Custom-Flutter-Engine-Embedders) ⭐ 178,440 | 🐛 13,162 | 🌐 Dart | 📅 2026-08-18 using a single code base that runs on Windows, macOS, and Linux. For rendering, [GLFW](https://github.com/go-gl/glfw) ⭐ 1,690 | 🐛 26 | 🌐 C | 📅 2026-08-02 fits the job because it provides the right abstractions over the OpenGL's Buffer/Mouse/Keyboard for each platform.
...
[Pop!\_OS Shell](https://github.com/pop-os/shell) ⭐ 5,270 | 🐛 449 | 🌐 TypeScript | 📅 2026-07-06is a keyboard-driven layer for GNOME Shell which allows for quick and sensible navigation and management of windows(tiling window management).
