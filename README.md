...
[Pop Shell](https://github.com/pop-os/shell) ⭐ 5,281 | 🐛 451 | 🌐 TypeScript | 📅 2026-08-20 is a keyboard-driven layer for GNOME Shell which allows for quick and sensible navigation and management of windows. The core feature of Pop Shell is the addition of advanced tiling window management similar to i3wm.
...
[Proton](https://github.com/ValveSoftware/Proton/) ⭐ 32,825 | 🐛 5,195 | 🌐 C++ | 📅 2026-09-17 is a tool for use with the Steam client which allows games which are exclusive to Windows to run on the Linux operating system. It uses Wine to facilitate this.
...
[syzkaller](https://github.com/google/syzkaller) ⭐ 6,323 | 🐛 634 | 🌐 Go | 📅 2026-09-17 is an unsupervised, coverage-guided kernel fuzzer.
...
[Podman(the POD MANager)](https://github.com/containers/podman) ⭐ 32,881 | 🐛 1,036 | 🌐 Go | 📅 2026-09-17 is a tool for managing [OCI](https://opencontainers.org/) containers and pods.
...
[Style Guide for Flutter](https://github.com/flutter/flutter/wiki/Style-guide-for-Flutter-repo) ⭐ 178,984 | 🐛 13,185 | 🌐 Dart | 📅 2026-09-17
...
[Go-flutter](https://github.com/go-flutter-desktop/go-flutter) ⭐ 5,931 | 🐛 65 | 🌐 Go | 📅 2026-09-08 is a package that brings Flutter to the desktop. project implements the [Flutter's Embedding API](https://github.com/flutter/flutter/wiki/Custom-Flutter-Engine-Embedders) ⭐ 178,984 | 🐛 13,185 | 🌐 Dart | 📅 2026-09-17 using a single code base that runs on Windows, macOS, and Linux. For rendering, [GLFW](https://github.com/go-gl/glfw) ⭐ 1,692 | 🐛 23 | 🌐 C | 📅 2026-08-23 fits the job because it provides the right abstractions over the OpenGL's Buffer/Mouse/Keyboard for each platform.
...
[Pop!\_OS Shell](https://github.com/pop-os/shell) ⭐ 5,281 | 🐛 451 | 🌐 TypeScript | 📅 2026-08-20is a keyboard-driven layer for GNOME Shell which allows for quick and sensible navigation and management of windows(tiling window management).
