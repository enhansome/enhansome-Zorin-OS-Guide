...
[Proton](https://github.com/ValveSoftware/Proton/) ⭐ 32,873 | 🐛 5,202 | 🌐 C++ | 📅 2026-09-24 is a tool for use with the Steam client which allows games which are exclusive to Windows to run on the Linux operating system. It uses Wine to facilitate this.
...
[SteamVR for Linux](https://github.com/ValveSoftware/SteamVR-for-Linux) ⭐ 1,072 | 🐛 457 | 📅 2026-06-06 is the ultimate tool for experiencing VR content on the hardware of your choice. SteamVR supports the Valve Index, HTC Vive, Oculus Rift, Windows Mixed Reality headsets, and others.
...
[Kubespray](https://kubespray.io/) is a tool that combines Kubernetes and Ansible to easily install Kubernetes clusters that can be deployed on [AWS](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/aws.md) ⭐ 18,750 | 🐛 207 | 🌐 Jinja | 📅 2026-09-24, GCE, [Azure](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/azure.md) ⭐ 18,750 | 🐛 207 | 🌐 Jinja | 📅 2026-09-24, [OpenStack](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/openstack.md) ⭐ 18,750 | 🐛 207 | 🌐 Jinja | 📅 2026-09-24, [vSphere](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/vsphere.md) ⭐ 18,750 | 🐛 207 | 🌐 Jinja | 📅 2026-09-24, [Packet](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/packet.md) ⭐ 18,750 | 🐛 207 | 🌐 Jinja | 📅 2026-09-24 (bare metal), Oracle Cloud Infrastructure (Experimental), or Baremetal.
...
[Numba](https://github.com/numba/numba) ⭐ 11,159 | 🐛 1,803 | 🌐 Python | 📅 2026-09-21 is an open source, NumPy-aware optimizing compiler for Python sponsored by Anaconda, Inc. It uses the LLVM compiler project to generate machine code from Python syntax. Numba can compile a large subset of numerically-focused Python, including many NumPy functions. Additionally, Numba has support for automatic parallelization of loops, generation of GPU-accelerated code, and creation of ufuncs and C callbacks.

[Chainer](https://chainer.org/) is a Python-based deep learning framework aiming at flexibility. It provides automatic differentiation APIs based on the define-by-run approach (dynamic computational graphs) as well as object-oriented high-level APIs to build and train neural networks. It also supports CUDA/cuDNN using [CuPy](https://github.com/cupy/cupy) ⭐ 12,342 | 🐛 688 | 🌐 Python | 📅 2026-09-23 for high performance training and inference.
...
[Google's Differential Privacy Library](https://github.com/google/differential-privacy) ⭐ 3,364 | 🐛 62 | 🌐 Go | 📅 2026-09-23
...
[Podman(the POD MANager)](https://github.com/containers/podman) ⭐ 32,921 | 🐛 1,017 | 🌐 Go | 📅 2026-09-24 is a tool for managing [OCI](https://opencontainers.org/) containers and pods.
...
[Style Guide for Flutter](https://github.com/flutter/flutter/wiki/Style-guide-for-Flutter-repo) ⭐ 179,068 | 🐛 13,281 | 🌐 Dart | 📅 2026-09-24
...
[Go-flutter](https://github.com/go-flutter-desktop/go-flutter) ⭐ 5,932 | 🐛 65 | 🌐 Go | 📅 2026-09-08 is a package that brings Flutter to the desktop. project implements the [Flutter's Embedding API](https://github.com/flutter/flutter/wiki/Custom-Flutter-Engine-Embedders) ⭐ 179,068 | 🐛 13,281 | 🌐 Dart | 📅 2026-09-24 using a single code base that runs on Windows, macOS, and Linux. For rendering, [GLFW](https://github.com/go-gl/glfw) ⭐ 1,691 | 🐛 24 | 🌐 C | 📅 2026-08-23 fits the job because it provides the right abstractions over the OpenGL's Buffer/Mouse/Keyboard for each platform.
