...
1. [Getting Started](https://github.com/mikeroyal/Zorin-OS-Guide#getting-started) ⭐ 118 | 🐛 1 | 🌐 Shell | 📅 2022-03-09

2. [Getting Software](https://github.com/mikeroyal/Zorin-OS-Guide#getting-software) ⭐ 118 | 🐛 1 | 🌐 Shell | 📅 2022-03-09

3. [Gaming](https://github.com/mikeroyal/Zorin-OS-Guide#gaming) ⭐ 118 | 🐛 1 | 🌐 Shell | 📅 2022-03-09

4. [Game Development](https://github.com/mikeroyal/Zorin-OS-Guide#game-development) ⭐ 118 | 🐛 1 | 🌐 Shell | 📅 2022-03-09

5. [Setting up a macOS Workspace](https://github.com/mikeroyal/Zorin-OS-Guide#setting-up-a-macos-workspace) ⭐ 118 | 🐛 1 | 🌐 Shell | 📅 2022-03-09

6. [Setting up a Windows 10 Workspace](https://github.com/mikeroyal/Zorin-OS-Guide#setting-up-a-windows-10-workspace) ⭐ 118 | 🐛 1 | 🌐 Shell | 📅 2022-03-09

7. [Using Android and Android Apps on Linux](https://github.com/mikeroyal/Zorin-OS-Guide#using-android-and-android-apps-on-linux) ⭐ 118 | 🐛 1 | 🌐 Shell | 📅 2022-03-09

8. [Professional Audio/Video Editing](https://github.com/mikeroyal/Zorin-OS-Guide#professional-audio--video-editing) ⭐ 118 | 🐛 1 | 🌐 Shell | 📅 2022-03-09

9. [Kubernetes](https://github.com/mikeroyal/Zorin-OS-Guide#kubernetes) ⭐ 118 | 🐛 1 | 🌐 Shell | 📅 2022-03-09

10. [Machine Learning](https://github.com/mikeroyal/Zorin-OS-Guide#machine-learning) ⭐ 118 | 🐛 1 | 🌐 Shell | 📅 2022-03-09

11. [Robotics](https://github.com/mikeroyal/Zorin-OS-Guide#robotics) ⭐ 118 | 🐛 1 | 🌐 Shell | 📅 2022-03-09

12. [Open Source Security](https://github.com/mikeroyal/Zorin-OS-Guide#open-source-security) ⭐ 118 | 🐛 1 | 🌐 Shell | 📅 2022-03-09

13. [Differential Privacy](https://github.com/mikeroyal/Zorin-OS-Guide#differential-privacy) ⭐ 118 | 🐛 1 | 🌐 Shell | 📅 2022-03-09

14. [Cloud Native Development](https://github.com/mikeroyal/Zorin-OS-Guide#cloud-native-development) ⭐ 118 | 🐛 1 | 🌐 Shell | 📅 2022-03-09

15. [DevOps Development](https://github.com/mikeroyal/Zorin-OS-Guide#devops-development) ⭐ 118 | 🐛 1 | 🌐 Shell | 📅 2022-03-09

16. [Flutter Development](https://github.com/mikeroyal/Zorin-OS-Guide#flutter-development) ⭐ 118 | 🐛 1 | 🌐 Shell | 📅 2022-03-09

17. [Networking](https://github.com/mikeroyal/Zorin-OS-Guide#networking) ⭐ 118 | 🐛 1 | 🌐 Shell | 📅 2022-03-09

18. [Databases](https://github.com/mikeroyal/Zorin-OS-Guide#databases) ⭐ 118 | 🐛 1 | 🌐 Shell | 📅 2022-03-09

19. [GNOME Extensions](https://github.com/mikeroyal/Zorin-OS-Guide#gnome-extensions) ⭐ 118 | 🐛 1 | 🌐 Shell | 📅 2022-03-09

20. [Advanced Topics](https://github.com/mikeroyal/Zorin-OS-Guide#advanced-topics) ⭐ 118 | 🐛 1 | 🌐 Shell | 📅 2022-03-09
...
[Pop Shell](https://github.com/pop-os/shell) ⭐ 5,271 | 🐛 450 | 🌐 TypeScript | 📅 2026-08-20 is a keyboard-driven layer for GNOME Shell which allows for quick and sensible navigation and management of windows. The core feature of Pop Shell is the addition of advanced tiling window management similar to i3wm.
...
[Back to the Top](https://github.com/mikeroyal/Zorin-OS-Guide/blob/main/README.md#table-of-contents) ⭐ 118 | 🐛 1 | 🌐 Shell | 📅 2022-03-09
...
[Back to the Top](https://github.com/mikeroyal/Zorin-OS-Guide#table-of-contents) ⭐ 118 | 🐛 1 | 🌐 Shell | 📅 2022-03-09
...
[Proton](https://github.com/ValveSoftware/Proton/) ⭐ 32,650 | 🐛 5,175 | 🌐 C++ | 📅 2026-08-26 is a tool for use with the Steam client which allows games which are exclusive to Windows to run on the Linux operating system. It uses Wine to facilitate this.
...
[Winetricks](https://github.com/Winetricks/winetricks) ⭐ 3,520 | 🐛 181 | 🌐 Shell | 📅 2026-08-07 is an easy way to work around problems in Wine.
...
[K3s](https://github.com/rancher/k3s) ⭐ 33,821 | 🐛 73 | 🌐 Go | 📅 2026-08-25 is a highly available, certified Kubernetes distribution designed for production workloads in unattended, resource-constrained, remote locations or inside IoT appliances.
...
[Chainer](https://chainer.org/) is a Python-based deep learning framework aiming at flexibility. It provides automatic differentiation APIs based on the define-by-run approach (dynamic computational graphs) as well as object-oriented high-level APIs to build and train neural networks. It also supports CUDA/cuDNN using [CuPy](https://github.com/cupy/cupy) ⭐ 12,275 | 🐛 709 | 🌐 Python | 📅 2026-08-25 for high performance training and inference.

[cuML](https://github.com/rapidsai/cuml) ⭐ 5,262 | 🐛 852 | 🌐 Python | 📅 2026-08-26 is a suite of libraries that implement machine learning algorithms and mathematical primitives functions that share compatible APIs with other RAPIDS projects. cuML enables data scientists, researchers, and software engineers to run traditional tabular ML tasks on GPUs without going into the details of CUDA programming. In most cases, cuML's Python API matches the API from scikit-learn.
...
[EarlyOOM](https://github.com/rfjakob/earlyoom) ⭐ 4,237 | 🐛 34 | 🌐 C | 📅 2026-08-20 is a daemon for Linux that enables users to more quickly recover and regain control over their system in low-memory situations with heavy swap usage.
...
[PyTorch Geometric (PyG)](https://github.com/rusty1s/pytorch_geometric) ⭐ 24,031 | 🐛 1,309 | 🌐 Python | 📅 2026-08-24 is a geometric deep learning extension library for [PyTorch](https://pytorch.org/).
...
[Podman(the POD MANager)](https://github.com/containers/podman) ⭐ 32,696 | 🐛 1,135 | 🌐 Go | 📅 2026-08-26 is a tool for managing [OCI](https://opencontainers.org/) containers and pods.
...
[Style Guide for Flutter](https://github.com/flutter/flutter/wiki/Style-guide-for-Flutter-repo) ⭐ 178,661 | 🐛 13,157 | 🌐 Dart | 📅 2026-08-26
...
[Go-flutter](https://github.com/go-flutter-desktop/go-flutter) ⭐ 5,931 | 🐛 65 | 🌐 Go | 📅 2026-08-23 is a package that brings Flutter to the desktop. project implements the [Flutter's Embedding API](https://github.com/flutter/flutter/wiki/Custom-Flutter-Engine-Embedders) ⭐ 178,661 | 🐛 13,157 | 🌐 Dart | 📅 2026-08-26 using a single code base that runs on Windows, macOS, and Linux. For rendering, [GLFW](https://github.com/go-gl/glfw) ⭐ 1,690 | 🐛 22 | 🌐 C | 📅 2026-08-23 fits the job because it provides the right abstractions over the OpenGL's Buffer/Mouse/Keyboard for each platform.
...
[Pop!\_OS Shell](https://github.com/pop-os/shell) ⭐ 5,271 | 🐛 450 | 🌐 TypeScript | 📅 2026-08-20is a keyboard-driven layer for GNOME Shell which allows for quick and sensible navigation and management of windows(tiling window management).
...
* [x] If would you like to contribute to this guide simply make a [Pull Request](https://github.com/mikeroyal/Zorin-OS-Guide/pulls) ⭐ 118 | 🐛 1 | 🌐 Shell | 📅 2022-03-09.
